...
export default function Slug({ Data }) {
    ...
    return (
        <>
                ...
                <section class="text-gray-600 body-font overflow-hidden">
                    <div class="container px-5 py-24 mx-auto">
                        <div class="lg:w-4/5 mx-auto flex flex-wrap">
                            <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={Data && Data.img} />
                            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{Data && Data.title}</h1>
                                <div class="flex mb-4">
                                ...
                                <p class="leading-relaxed">{Data && Data.description}</p>
                                {Data && Data.active == 'false' &&
                                    <p className='text-red-500 uppercase'>*Out Of Stock</p>
                                }
                                <div class="flex mt-5">
                                    <span class="title-font font-medium text-2xl text-gray-900">₹{Data && Data.price}</span>
                                    ...
                                    <Link href={'/checkout/' + slug}><button class="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Buy Now</button></Link>
            ...
            {Data == null &&
                <Image src={'/404.png'} layout='fill'></Image>
            }
        </>
    )
}
