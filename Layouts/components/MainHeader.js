...
export default function MainHeader() {
    ...
    return (
        <>
                ...
                <div class="container mx-auto px-6 py-3">
                    <div class="flex items-center justify-between">
                        <div class="hidden w-full text-gray-600 md:flex md:items-center">
                            ...
                            <span class="mx-1 text-sm">IN</span>
                        </div>
                        <div class="w-full nav text-gray-700 md:text-center text-2xl font-semibold cursor-pointer">
                            <Link href={'/'}><span>Galoten</span></Link>
                        </div>
                        <div class="flex items-center justify-end w-full">
                            <button onClick={() => { handelcart() }} class="text-gray-600 focus:outline-none mx-4 sm:mx-0">
                    ...
                    <nav class="sm:flex sm:justify-center sm:items-center mt-4">
                        <div class="flex flex-col sm:flex-row">
                            <Link href={'/mainpage'}><a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0">Home</a></Link>
                            <a class="mt-3 text-gray-600 sm:mx-3 sm:mt-0" href="#">Shop</a>
                            <a class="mt-3 text-gray-600 sm:mx-3 sm:mt-0" href="#">Categories</a>
                            <a class="mt-3 text-gray-600 sm:mx-3 sm:mt-0" href="#">Contact</a>
                            <a class="mt-3 text-gray-600 sm:mx-3 sm:mt-0" href="#">About</a>
                        </div>
                    </nav>
            ...
            {/* THE CART */}
            <div class={`${NavClass} right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto bg-white border-l-2 border-gray-300`}>
                <div class="flex items-center justify-between">
                    <h3 class="text-2xl font-medium text-gray-700">Your cart</h3>
                    <button class="text-gray-600 focus:outline-none" onClick={handelcart}>
