        ...
        <header>
            <div class="container mx-auto px-6 py-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="w-full nav text-gray-700 md:text-center text-2xl font-semibold">
                        Galoten
                    </div>
                ...
                <nav class="sm:flex sm:justify-center sm:items-center mt-4">
                    <div class="flex flex-col sm:flex-row">
                        <Link href={'/mainpage '}><a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">Home</a></Link>
